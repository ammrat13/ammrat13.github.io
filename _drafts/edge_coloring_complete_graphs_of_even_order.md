...
@@\ell@@ --- edges separating @@\ell@@ vertices going along the rim --- with
just two colors. Why? Since @@n@@ is even but @@\ell@@ is odd, the cycle
@@\langle\ell\rangle@@ generated by @@\ell@@ will have an even number of
...
only @@\frac{1}{4}n-\frac{1}{2}@@ possible values @@\ell@@ can take, since
@@\ell@@ and @@n-\ell@@ are the same. We'll thus use @@\frac{1}{2}n-1@@ colors
for the edges of odd length, plus the @@\frac{1}{2}n@@ for the even edges and
midlines, giving @@n-1@@ colors total. Of course, I didn't realize this at the
time. Instead, I tried to find a number theoretic approach to coloring the edges
of even length, again to no avail. I only realized my geometric and number
theoretic approaches can be combined when I saw some of the pretty pictures
generated by the latter, such as the one below.
